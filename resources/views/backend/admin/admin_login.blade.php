...
<body class="hold-transition theme-primary bg-gradient-primary">
				...
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
						<div class="content-top-agile p-10">
							<h2 class="text-white">Ecommerce Login</h2>
						</div>
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed">

							<form method="POST" action="{{ route('admin_log') }}">
                                @csrf
								...
								<div class="form-group">
									<div class="input-group mb-3">
                                        ...
                                        autocomplete="current-password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password">
									</div>
								</div>
								  <div class="row">
									<div class="col-6">
									  {{--  <div class="checkbox text-white">
										<input type="checkbox" id="remember_me" name="remember" id="basic_checkbox_1" >
							...
							{{--  <div class="text-center">
								<p class="mt-15 mb-0 text-white">Don't have an account? <a class="btn btn-sm btn-info" href="" class="text-info ml-5">Sign Up</a></p>
							</div>  --}}
						</div>
					</div>
				</div>
    ...
    <script>
        ...
        @if(Session::has('hudai'))
        toastr.success("{{ Session::get('hudai') }}")
        @endif

        @if(Session::has('add_log'))
        toastr.success("{{ Session::get('add_log') }}")
        @endif
