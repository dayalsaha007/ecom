				...
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
						...
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
							<form method="POST" action="{{ route('store_add_reg') }}">
                                @csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="text" name="name" required class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Name">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password"
                                        name="password"
                                        required autocomplete="new-password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password"
                                        name="password_confirmation" required autocomplete="new-password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Retype Password">
									</div>
								</div>
								  <div class="row">
									{{--  <div class="col-12">
							...
							<div class="text-center">
								<p class="mt-15 mb-0 text-white">Already have an account?<a href="{{ route('admin_login') }}" class="text-danger ml-5  btn btn-sm btn-info"> Sign In</a></p>
							</div>
						</div>
					</div>
				</div>
