...
@section('page_header')
    {{ $product_info->p_name_eng }} Product detail
@endsection
                                ...
                                <div class="product-item-holder size-big single-product-gallery small-gallery">
                                    ...
                                    <div id="owl-single-product">
                                        ...
                                        @foreach ($multi_image as $mi)
                                            <div class="single-product-gallery-item" id="slide{{ $mi->id }}">
                                                <a data-lightbox="image-1" data-title="Gallery"
                                                    href="{{ asset('uploads/multi_image') }}/{{ $mi->multi_image }}">
                                                    <img class="img-responsive" alt=""
                                                        src="{{ asset('uploads/multi_image') }}/{{ $mi->multi_image }}"
                                                        data-echo="{{ asset('uploads/multi_image') }}/{{ $mi->multi_image }}" />
                                                </a>
                            ...
                            <div class='col-sm-6 col-md-7 product-info-block'>
                                <div class="product-info">
                                    ...
                                    <div class="description-container m-t-20">
                                        {{ session()->get('language') == 'hindi' ? $product_info->short_descp_hin : $product_info->short_descp_eng }}
                                            ...
                                            <div class="col-sm-6">
                                                <div class="price-box">
                                                    @if ($product_info->discount_price == null)
                                                        <span class="price">${{ $product_info->selling_price }}</span>
                                                    @else
                                                        <span class="price">${{ $product_info->selling_price }}</span>
                                                        <span
                                                            class="price-strike">${{ $product_info->discount_price }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="product-tab">
                                            <p class="text">
                                                @if (session()->get('language') == 'hindi')
                                                    {!! $product_info->long_descp_hin !!}
                                                @else
                                                    {!! $product_info->long_descp_eng !!}
                                                @endif
                                            </p>
                                        </div>
                                    </div><!-- /.tab-pane -->
                                 ...
                                 <div class="products">
                                     ...
                                     <div class="product">
                                         <div class="product-image">
                                             <div class="image">
                                                 <a href="{{ url('product/detail/'.$product->id.'/'.$product->p_slug_eng) }}"><img src="{{ asset('uploads/p_image') }}/{{ $product->p_image }}"
                                                         alt=""></a>
                                             </div><!-- /.image -->
                                             @php
